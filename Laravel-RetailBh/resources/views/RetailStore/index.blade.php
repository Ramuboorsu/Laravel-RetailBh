				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<a href="/login" onclick="document.getElementById('id04').style.display='block'" id="log" style="width:auto;color:white;">Login</a>
						</div>
						<!-- /LOGO -->
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="nav-item dropdown">
								...
								<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="/store1/2">Accessories</a></br>
