...
<html lang="en">
  ...
  width: 10%;
	...
	<meta name="csrf-token" content="{{ csrf_token() }}">
     ...
     <script src="{{asset('frontend')}}/actionmain.js"></script>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<a href="/login"  id="log" style="width:auto;color:white;">Login</a>
						</div>
						<!-- /LOGO -->
...
<tr>
    ...
    <td><input type='text' name='fname' required pattern="[A-Za-z]{3,30}" title="Minimum Length 3"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
    <td align='center'>Last Name:</td>
    <td><input type='text' name='lname' required pattern="[A-Za-z]{3,30}" title="TMinimum Length 3"></td>
</tr>
...
<tr>
    ...
    <td><input type='text' name='phone' required pattern="^[6-9][0-9]{9}" title="Mobile Number Should Began With 6/7/8/9 with valid 10 digit format"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
    ...
    <td><input type='email' name='email' required title="Enter in Email format"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<tr>
    <td align='center'>Password</td>
    <td><input type='password' name='password' required pattern="[A-Za-z0-9]{6,40}" title="Password Length Minimum 6"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>

<tr>
    <td align='center'>Confirm Password</td>
    <td><input type='password' name='cpassword' required pattern="[A-Za-z0-9]{6,40}" title="Password Length Minimum 6"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
