				...
				<!-- row -->
					...
					<!-- ASIDE -->
			           ...
			           <meta cost range>
						...
						<!-- aside Widget -->
						<meta selection of brand>
						<!-- /aside Widget -->

						<!-- aside Widget -->
						<meta top selling list>
						<!-- /aside Widget -->
					...
					<div id="store">
						...
						<div class="row">
						 ...
						 <?php
		           $prod=DB::table('products')->select('*')->where('product_cat',$id)->get();
		           foreach($prod as $pro){
							...
							<div class="col-xs-4 col-sm-4 col-lg-3">
								...
								<div class="product">
									...
									<div class="product-body">
										...
										<h4 class="product-price">$980.00 <del class="product-old-price"><?php echo $pro_price; ?></del></h4>
