				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<b style="color:white;">Welcome {{Session::get('email')}}</b>
							<a href="/logout" onclick="document.getElementById('id04').style.display='block'" id="log" style="width:auto;color:red">Logout</a>
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="nav-item dropdown">
								...
								<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="/2store1/2" id="Access">Accessories</a></br>
